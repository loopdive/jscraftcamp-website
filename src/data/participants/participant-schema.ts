...
/** A URL that is not empty and is optional */
const nonEmptyOptionalUrl = () => z.string().url().nonempty().nullish();

/** A boolean that is optional and defaults to false */
...
/** Type of the participant object */
export type Participant = z.infer<typeof ParticipantSchema>;

/** Type of the T-Shirt size */
